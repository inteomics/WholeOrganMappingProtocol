###########################
##R codes for identifying monotonic genes;
##Box 1 in "Protocol for integrative spatial multiplatform genomic analysis of bladder cancer evolution from mucosal field effects on the whole-organ scale";
##created by Roman Jaksik (Roman.Jaksik@polsl.pl);
###########################

SampleTableExtSel = readRDS('SampleTableExtSel_v1.RDS')
source('MDA_BLD_plotting_functions.R')
##need to unzip "RNAseq_DESeq2_Map19_v10.txt.zip"
...
mapID = "Map19"
  ...
  ########## data preparation ########### 
  DEGFile = paste0('RNAseq_DESeq2_',mapID,'_v10.txt')
